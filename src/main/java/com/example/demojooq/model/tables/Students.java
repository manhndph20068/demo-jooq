 ...
 */
package com.example.demojooq.model.tables;


import com.example.demojooq.model.Keys;
import com.example.demojooq.model.ManageStudents;
...
public class Students extends TableImpl<StudentsRecord> {
     ...
     */
    public final TableField<StudentsRecord, LocalDateTime> CREATE_AT = createField(DSL.name("create_at"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>manage_students.students.updated_at</code>.
     */
    public final TableField<StudentsRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>manage_students.students.status</code>.
     */
    public final TableField<StudentsRecord, Integer> STATUS = createField(DSL.name("status"), SQLDataType.INTEGER, this, "");
